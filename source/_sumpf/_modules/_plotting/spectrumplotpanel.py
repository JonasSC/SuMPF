...
class SpectrumPlotPanel(LinePlotPanel):
	...
	"""
	def __init__(self, parent, x_interval=(20, 20000), margin=0.1, show_legend=True, show_grid=None, log_x=True, log_y=set(["Magnitude"]), hidden_plots=set(["GroupDelay"])):
		"""
		...
		LinePlotPanel.__init__(self,
		                       parent=parent,
		                       plotnames=["Magnitude", "Phase", "GroupDelay"],
	...
	def LinearMagnitude(self):
		...
		"""
		self.LogarithmicY(plot="Magnitude", log=False)
	...
	def LogarithmicMagnitude(self):
		...
		"""
		self.LogarithmicY(plot="Magnitude", log=True)
	...
	def LinearPhase(self):
		...
		"""
		self.LogarithmicY(plot="Phase", log=False)
	...
	def LogarithmicPhase(self):
		...
		"""
		self.LogarithmicY(plot="Phase", log=True)
	...
	def LinearGroupDelay(self):
		...
		"""
		self.LogarithmicY(plot="GroupDelay", log=False)
	...
	def LogarithmicGroupDelay(self):
		...
		"""
		self.LogarithmicY(plot="GroupDelay", log=True)
	...
	def ShowMagnitude(self):
		...
		"""
		self.ShowPlot(plot="Magnitude", show=True)
	...
	def HideMagnitude(self):
		...
		"""
		self.ShowPlot(plot="Magnitude", show=False)
	...
	def ShowPhase(self):
		...
		"""
		self.ShowPlot(plot="Phase", show=True)
	...
	def HidePhase(self):
		...
		"""
		self.ShowPlot(plot="Phase", show=False)
	...
	def ShowGroupDelay(self):
		...
		"""
		self.ShowPlot(plot="GroupDelay", show=True)
	...
	def HideGroupDelay(self):
		...
		"""
		self.ShowPlot(plot="GroupDelay", show=False)
