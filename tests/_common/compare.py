...
def compare_signals_almost_equal(testcase, signal1, signal2, places=7):
	"""
	...
	compare_channeldatas_almost_equal(testcase=testcase, data1=signal1, data2=signal2, places=places)

def compare_spectrums_almost_equal(testcase, spectrum1, spectrum2, places=7):
	"""
	...
	compare_channeldatas_almost_equal(testcase=testcase, data1=spectrum1, data2=spectrum2, places=places)

def compare_channeldatas_almost_equal(testcase, data1, data2, places):
	"""
